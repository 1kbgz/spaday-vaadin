import{a as o,b as r}from"./chunk-47SZQVFY.js";import{c as a}from"./chunk-V3TG64QR.js";["--vaadin-text-color","--vaadin-text-color-disabled","--vaadin-text-color-secondary","--vaadin-border-color","--vaadin-border-color-secondary","--vaadin-background-color"].forEach(n=>{o({name:n,syntax:"<color>",inherits:!0,initialValue:"transparent"})});r("vaadin-base",a`
    @layer vaadin.base {
      html {
        /* Background color */
